...
* saremo al piano terra, in un'unica sala di oltre 600mq che divideremo in (almeno) tre zone:
	...
	* due zone laterali ai due angoli estremi della stanza. Ci serviranno per le sessioni parallele del sabato e per le sessioni degli hackathon della domenica.
...
**Quest'anno il raduno dura 2 giorni** (_e non i soliti 3_). Come per tutti gli altri raduni SOD, il programma è costruito dal basso, dalla comunità. Qui di seguito la versione _in bozza_ del programma:

#### 1 Giugno 2019 - (Un)Conference - prima giornata

**Orari della giornata**: 9.30 - 18:30 circa
...
<table class="table table-hover table-responsive table-condensed" align="center" style="width: 90%">
	...
	<tbody>
			...
			<td>Come organizzare e rappresentare la domanda di Open Data (Matteo Brunati e altri)</td>
			<td>Scriptorium digitale, per preservare la cultura digitale da un nuovo Medioevo (Matteo Fortini)</td>
    		</tr>
	</tbody>
</table>
